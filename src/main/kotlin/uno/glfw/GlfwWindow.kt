...
//        set(value) = glfwSetWindowAspectRatio(handle, (value * 1_000).i, 1_000)
    ...
    fun pressed(key: Int) = glfwGetKey(handle.L, key) == GLFW_PRESS
    fun released(key: Int) = glfwGetKey(handle.L, key) == GLFW_PRESS

    fun mouseButton(button: Int) = glfwGetMouseButton(handle.L, button)
