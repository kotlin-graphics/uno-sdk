...
fun GL3.initArrayBuffer(buffer: IntBuffer, block: Buffer.() -> Unit) {
    buffer[0] = initBuffer(GL.GL_ARRAY_BUFFER, block)
}

fun GL3.initElementBuffer(buffer: IntBuffer, block: Buffer.() -> Unit) {
    buffer[0] = initBuffer(GL.GL_ELEMENT_ARRAY_BUFFER, block)
}

fun GL3.initUniformBuffer(buffer: IntBuffer, block: Buffer.() -> Unit) {
    buffer[0] = initBuffer(GL3.GL_UNIFORM_BUFFER, block)
}

fun GL3.initUniformBuffers(buffers: IntBuffer, block: Buffers.() -> Unit) {
    Buffers.gl = this
    Buffers.target = GL2ES3.GL_UNIFORM_BUFFER
...
fun GL3.initBuffers(buffers: IntBuffer, block: Buffers.() -> Unit) {
    Buffers.gl = this
    glGenBuffers(buffers.capacity(), buffers)
    Buffers.buffers = buffers
    Buffers.block()
...
fun GL3.withBuffer(target: Int, buffer: IntBuffer, block: Buffer.() -> Unit) = withBuffer(target, buffer[0], block)
fun GL3.withBuffer(target: Int, buffer: Int, block: Buffer.() -> Unit) {
    Buffer.gl = this
    Buffer.target = target
...
fun GL3.withArrayBuffer(buffer: IntBuffer, block: Buffer.() -> Unit) = withBuffer(GL.GL_ARRAY_BUFFER, buffer[0], block)
fun GL3.withArrayBuffer(buffer: Int, block: Buffer.() -> Unit) = withBuffer(GL.GL_ARRAY_BUFFER, buffer, block)
fun GL3.withElementBuffer(buffer: IntBuffer, block: Buffer.() -> Unit) = withBuffer(GL.GL_ELEMENT_ARRAY_BUFFER, buffer[0], block)
fun GL3.withElementBuffer(buffer: Int, block: Buffer.() -> Unit) = withBuffer(GL.GL_ELEMENT_ARRAY_BUFFER, buffer, block)
fun GL3.withUniformBuffer(buffer: IntBuffer, block: Buffer.() -> Unit) = withBuffer(GL3.GL_UNIFORM_BUFFER, buffer[0], block)
fun GL3.withUniformBuffer(buffer: Int, block: Buffer.() -> Unit) = withBuffer(GL3.GL_UNIFORM_BUFFER, buffer, block)
