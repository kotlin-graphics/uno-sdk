...
fun glUniform(location: Int, mat2: Mat2) = GL20.glUniformMatrix2fv(location, false, mat2 to m2Buf)
fun glUniform(location: Int, mat2x3: Mat2x3) = GL21.glUniformMatrix2x3fv(location, false, mat2x3 to m23Buf)
fun glUniform(location: Int, mat2x4: Mat2x4) = GL21.glUniformMatrix2x4fv(location, false, mat2x4 to m24Buf)
fun glUniform(location: Int, mat3x2: Mat3x2) = GL21.glUniformMatrix3x2fv(location, false, mat3x2 to m32Buf)
fun glUniform(location: Int, mat3: Mat3) = GL20.glUniformMatrix3fv(location, false, mat3 to m3Buf)
fun glUniform(location: Int, mat3x4: Mat3x4) = GL21.glUniformMatrix3x4fv(location, false, mat3x4 to m34Buf)
fun glUniform(location: Int, mat4x2: Mat4x2) = GL21.glUniformMatrix4x2fv(location, false, mat4x2 to m42Buf)
fun glUniform(location: Int, mat4x3: Mat4x3) = GL21.glUniformMatrix4x3fv(location, false, mat4x3 to m43Buf)
fun glUniform(location: Int, mat4: Mat4) = GL20.glUniformMatrix4fv(location, false, mat4 to m4Buf)
