...
class Caps(
    ...
    inner class Extensions(gl: GL) {
        ...
        val ARB_multitexture = list.contains("GL_ARB_multitexture")
        val ARB_transpose_matrix = list.contains("GL_ARB_transpose_matrix")
        val ARB_multisample = list.contains("GL_ARB_multisample")
        val ARB_texture_env_add = list.contains("GL_ARB_texture_env_add")
        val ARB_texture_cube_map = list.contains("GL_ARB_texture_cube_map")
        val ARB_texture_compression = list.contains("GL_ARB_texture_compression")
        val ARB_texture_border_clamp = list.contains("GL_ARB_texture_border_clamp")
        val ARB_point_parameters = list.contains("GL_ARB_point_parameters")
        val ARB_vertex_blend = list.contains("GL_ARB_vertex_blend")
        val ARB_matrix_palette = list.contains("GL_ARB_matrix_palette")
        val ARB_texture_env_combine = list.contains("GL_ARB_texture_env_combine")
        val ARB_texture_env_crossbar = list.contains("GL_ARB_texture_env_crossbar")
        val ARB_texture_env_dot3 = list.contains("GL_ARB_texture_env_dot3")
        val ARB_texture_mirrored_repeat = list.contains("GL_ARB_texture_mirrored_repeat")
        val ARB_depth_texture = list.contains("GL_ARB_depth_texture")
        val ARB_shadow = list.contains("GL_ARB_shadow")
        val ARB_shadow_ambient = list.contains("GL_ARB_shadow_ambient")
        val ARB_window_pos = list.contains("GL_ARB_window_pos")
        val ARB_vertex_program = list.contains("GL_ARB_vertex_program")
        val ARB_fragment_program = list.contains("GL_ARB_fragment_program")
        val ARB_vertex_buffer_object = list.contains("GL_ARB_vertex_buffer_object")
        val ARB_occlusion_query = list.contains("GL_ARB_occlusion_query")
        val ARB_shader_objects = list.contains("GL_ARB_shader_objects")
        val ARB_vertex_shader = list.contains("GL_ARB_vertex_shader")
        val ARB_fragment_shader = list.contains("GL_ARB_fragment_shader")
        val ARB_shading_language_100 = list.contains("GL_ARB_shading_language_100")
        val ARB_texture_non_power_of_two = list.contains("GL_ARB_texture_non_power_of_two")
        val ARB_point_sprite = list.contains("GL_ARB_point_sprite")
        val ARB_fragment_program_shadow = list.contains("GL_ARB_fragment_program_shadow")
        val ARB_draw_buffers = list.contains("GL_ARB_draw_buffers")
        val ARB_texture_rectangle = list.contains("GL_ARB_texture_rectangle")
        val ARB_color_buffer_float = list.contains("GL_ARB_color_buffer_float")
        val ARB_half_float_pixel = list.contains("GL_ARB_half_float_pixel")
        val ARB_texture_float = list.contains("GL_ARB_texture_float")
        val ARB_pixel_buffer_object = list.contains("GL_ARB_pixel_buffer_object")
        val ARB_depth_buffer_float = list.contains("GL_ARB_depth_buffer_float")
        val ARB_draw_instanced = list.contains("GL_ARB_draw_instanced")
        val ARB_framebuffer_object = list.contains("GL_ARB_framebuffer_object")
        val ARB_framebuffer_sRGB = list.contains("GL_ARB_framebuffer_sRGB")
        val ARB_geometry_shader4 = list.contains("GL_ARB_geometry_shader4")
        val ARB_half_float_vertex = list.contains("GL_ARB_half_float_vertex")
        val ARB_instanced_arrays = list.contains("GL_ARB_instanced_arrays")
        val ARB_map_buffer_range = list.contains("GL_ARB_map_buffer_range")
        val ARB_texture_buffer_object = list.contains("GL_ARB_texture_buffer_object")
        val ARB_texture_compression_rgtc = list.contains("GL_ARB_texture_compression_rgtc")
        val ARB_texture_rg = list.contains("GL_ARB_texture_rg")
        val ARB_vertex_array_object = list.contains("GL_ARB_vertex_array_object")
        val ARB_uniform_buffer_object = list.contains("GL_ARB_uniform_buffer_object")
        val ARB_compatibility = list.contains("GL_ARB_compatibility")
        val ARB_copy_buffer = list.contains("GL_ARB_copy_buffer")
        val ARB_shader_texture_lod = list.contains("GL_ARB_shader_texture_lod")
        val ARB_depth_clamp = list.contains("GL_ARB_depth_clamp")
        val ARB_draw_elements_base_vertex = list.contains("GL_ARB_draw_elements_base_vertex")
        val ARB_fragment_coord_conventions = list.contains("GL_ARB_fragment_coord_conventions")
        val ARB_provoking_vertex = list.contains("GL_ARB_provoking_vertex")
        val ARB_seamless_cube_map = list.contains("GL_ARB_seamless_cube_map")
        val ARB_sync = list.contains("GL_ARB_sync")
        val ARB_texture_multisample = list.contains("GL_ARB_texture_multisample")
        val ARB_vertex_array_bgra = list.contains("GL_ARB_vertex_array_bgra")
        val ARB_draw_buffers_blend = list.contains("GL_ARB_draw_buffers_blend")
        val ARB_sample_shading = list.contains("GL_ARB_sample_shading")
        val ARB_texture_cube_map_array = list.contains("GL_ARB_texture_cube_map_array")
        val ARB_texture_gather = list.contains("GL_ARB_texture_gather")
        val ARB_texture_query_lod = list.contains("GL_ARB_texture_query_lod")
        val ARB_shading_language_include = list.contains("GL_ARB_shading_language_include")
        val ARB_texture_compression_bptc = list.contains("GL_ARB_texture_compression_bptc")
        val ARB_blend_func_extended = list.contains("GL_ARB_blend_func_extended")
        val ARB_explicit_attrib_location = list.contains("GL_ARB_explicit_attrib_location")
        val ARB_occlusion_query2 = list.contains("GL_ARB_occlusion_query2")
        val ARB_sampler_objects = list.contains("GL_ARB_sampler_objects")
        val ARB_shader_bit_encoding = list.contains("GL_ARB_shader_bit_encoding")
        val ARB_texture_rgb10_a2ui = list.contains("GL_ARB_texture_rgb10_a2ui")
        val ARB_texture_swizzle = list.contains("GL_ARB_texture_swizzle")
        val ARB_timer_query = list.contains("GL_ARB_timer_query")
        val ARB_vertex_type_2_10_10_10_rev = list.contains("GL_ARB_vertex_type_2_10_10_10_rev")
        val ARB_draw_indirect = list.contains("GL_ARB_draw_indirect")
        val ARB_gpu_shader5 = list.contains("GL_ARB_gpu_shader5")
        val ARB_gpu_shader_fp64 = list.contains("GL_ARB_gpu_shader_fp64")
        val ARB_shader_subroutine = list.contains("GL_ARB_shader_subroutine")
        val ARB_tessellation_shader = list.contains("GL_ARB_tessellation_shader")
        val ARB_texture_buffer_object_rgb32 = list.contains("GL_ARB_texture_buffer_object_rgb32")
        val ARB_transform_feedback2 = list.contains("GL_ARB_transform_feedback2")
        val ARB_transform_feedback3 = list.contains("GL_ARB_transform_feedback3")
        val ARB_ES2_compatibility = list.contains("GL_ARB_ES2_compatibility")
        val ARB_get_program_binary = list.contains("GL_ARB_get_program_binary")
        val ARB_separate_shader_objects = list.contains("GL_ARB_separate_shader_objects")
        val ARB_shader_precision = list.contains("GL_ARB_shader_precision")
        val ARB_vertex_attrib_64bit = list.contains("GL_ARB_vertex_attrib_64bit")
        val ARB_viewport_array = list.contains("GL_ARB_viewport_array")
        val ARB_cl_event = list.contains("GL_ARB_cl_event")
        val ARB_debug_output = list.contains("GL_ARB_debug_output")
        val ARB_robustness = list.contains("GL_ARB_robustness")
        val ARB_shader_stencil_export = list.contains("GL_ARB_shader_stencil_export")
        val ARB_base_instance = list.contains("GL_ARB_base_instance")
        val ARB_shading_language_420pack = list.contains("GL_ARB_shading_language_420pack")
        val ARB_transform_feedback_instanced = list.contains("GL_ARB_transform_feedback_instanced")
        val ARB_compressed_texture_pixel_storage = list.contains("GL_ARB_compressed_texture_pixel_storage")
        val ARB_conservative_depth = list.contains("GL_ARB_conservative_depth")
        val ARB_internalformat_query = list.contains("GL_ARB_internalformat_query")
        val ARB_map_buffer_alignment = list.contains("GL_ARB_map_buffer_alignment")
        val ARB_shader_atomic_counters = list.contains("GL_ARB_shader_atomic_counters")
        val ARB_shader_image_load_store = list.contains("GL_ARB_shader_image_load_store")
        val ARB_shading_language_packing = list.contains("GL_ARB_shading_language_packing")
        val ARB_texture_storage = list.contains("GL_ARB_texture_storage")
        val KHR_texture_compression_astc_hdr = list.contains("GL_KHR_texture_compression_astc_hdr")
        val KHR_texture_compression_astc_ldr = list.contains("GL_KHR_texture_compression_astc_ldr")
        val KHR_debug = list.contains("GL_KHR_debug")
        val ARB_arrays_of_arrays = list.contains("GL_ARB_arrays_of_arrays")
        val ARB_clear_buffer_object = list.contains("GL_ARB_clear_buffer_object")
        val ARB_compute_shader = list.contains("GL_ARB_compute_shader")
        val ARB_copy_image = list.contains("GL_ARB_copy_image")
        val ARB_texture_view = list.contains("GL_ARB_texture_view")
        val ARB_vertex_attrib_binding = list.contains("GL_ARB_vertex_attrib_binding")
        val ARB_robustness_isolation = list.contains("GL_ARB_robustness_isolation")
        val ARB_ES3_compatibility = list.contains("GL_ARB_ES3_compatibility")
        val ARB_explicit_uniform_location = list.contains("GL_ARB_explicit_uniform_location")
        val ARB_fragment_layer_viewport = list.contains("GL_ARB_fragment_layer_viewport")
        val ARB_framebuffer_no_attachments = list.contains("GL_ARB_framebuffer_no_attachments")
        val ARB_internalformat_query2 = list.contains("GL_ARB_internalformat_query2")
        val ARB_invalidate_subdata = list.contains("GL_ARB_invalidate_subdata")
        val ARB_multi_draw_indirect = list.contains("GL_ARB_multi_draw_indirect")
        val ARB_program_interface_query = list.contains("GL_ARB_program_interface_query")
        val ARB_robust_buffer_access_behavior = list.contains("GL_ARB_robust_buffer_access_behavior")
        val ARB_shader_image_size = list.contains("GL_ARB_shader_image_size")
        val ARB_shader_storage_buffer_object = list.contains("GL_ARB_shader_storage_buffer_object")
        val ARB_stencil_texturing = list.contains("GL_ARB_stencil_texturing")
        val ARB_texture_buffer_range = list.contains("GL_ARB_texture_buffer_range")
        val ARB_texture_query_levels = list.contains("GL_ARB_texture_query_levels")
        val ARB_texture_storage_multisample = list.contains("GL_ARB_texture_storage_multisample")
        val ARB_buffer_storage = list.contains("GL_ARB_buffer_storage")
        val ARB_clear_texture = list.contains("GL_ARB_clear_texture")
        val ARB_enhanced_layouts = list.contains("GL_ARB_enhanced_layouts")
        val ARB_multi_bind = list.contains("GL_ARB_multi_bind")
        val ARB_query_buffer_object = list.contains("GL_ARB_query_buffer_object")
        val ARB_texture_mirror_clamp_to_edge = list.contains("GL_ARB_texture_mirror_clamp_to_edge")
        val ARB_texture_stencil8 = list.contains("GL_ARB_texture_stencil8")
        val ARB_vertex_type_10f_11f_11f_rev = list.contains("GL_ARB_vertex_type_10f_11f_11f_rev")
        val ARB_bindless_texture = list.contains("GL_ARB_bindless_texture")
        val ARB_compute_valiable_group_size = list.contains("GL_ARB_compute_valiable_group_size")
        val ARB_indirect_parameters = list.contains("GL_ARB_indirect_parameters")
        val ARB_seamless_cubemap_per_texture = list.contains("GL_ARB_seamless_cubemap_per_texture")
        val ARB_shader_draw_parameters = list.contains("GL_ARB_shader_draw_parameters")
        val ARB_shader_group_vote = list.contains("GL_ARB_shader_group_vote")
        val ARB_sparse_texture = list.contains("GL_ARB_sparse_texture")
        val ARB_ES3_1_compatibility = list.contains("GL_ARB_ES3_1_compatibility")
        val ARB_clip_control = list.contains("GL_ARB_clip_control")
        val ARB_conditional_render_inverted = list.contains("GL_ARB_conditional_render")
        val ARB_cull_distance = list.contains("GL_ARB_cull_distance")
        val ARB_derivative_control = list.contains("GL_ARB_derivative_control")
        val ARB_direct_state_access = list.contains("GL_ARB_direct_state_access")
        val ARB_get_texture_sub_image = list.contains("GL_ARB_get_texture_sub_image")
        val ARB_shader_texture_image_samples = list.contains("GL_ARB_shader_texture_image_samples")
        val ARB_texture_barrier = list.contains("GL_ARB_texture_barrier")
        val KHR_context_flush_control = list.contains("GL_KHR_context_flush_control")
        val KHR_robust_buffer_access_behavior = list.contains("GL_KHR_robust_buffer_access_behavior")
        val KHR_robustness = list.contains("GL_KHR_robustness")
        val ARB_pipeline_statistics_query = list.contains("GL_ARB_pipeline_statistics_query")
        val ARB_sparse_buffer = list.contains("GL_ARB_sparse_buffer")
        val ARB_transform_feedback_overflow_query = list.contains("GL_ARB_transform_feedback_overflow_query")

        // EXT
        val EXT_texture_compression_latc = list.contains("GL_EXT_texture_compression_latc")
        val EXT_transform_feedback = list.contains("GL_EXT_transform_feedback")
        val EXT_direct_state_access = list.contains("GL_EXT_direct_state_access")
        val EXT_texture_filter_anisotropic = list.contains("GL_EXT_texture_filter_anisotropic")
        val EXT_texture_compression_s3tc = list.contains("GL_EXT_texture_compression_s3tc")
        val EXT_texture_array = list.contains("GL_EXT_texture_array")
        val EXT_texture_snorm = list.contains("GL_EXT_texture_snorm")
        val EXT_texture_sRGB_decode = list.contains("GL_EXT_texture_sRGB_decode")
        val EXT_framebuffer_multisample_blit_scaled = list.contains("GL_EXT_framebuffer_multisample_blit_scaled")
        val EXT_shader_integer_mix = list.contains("GL_EXT_shader_integer_mix")
        val EXT_shader_image_load_formatted = list.contains("GL_EXT_shader_image_load_formatted")
        val EXT_polygon_offset_clamp = list.contains("GL_EXT_polygon_offset_clamp")

        // NV
        val NV_explicit_multisample = list.contains("GL_NV_explicit_multisample")
        val NV_shader_buffer_load = list.contains("GL_NV_shader_buffer_load")
        val NV_vertex_buffer_unified_memory = list.contains("GL_NV_vertex_buffer_unified_memory")
        val NV_shader_buffer_store = list.contains("GL_NV_shader_buffer_store")
        val NV_bindless_multi_draw_indirect = list.contains("GL_NV_bindless_multi_draw_indirect")
        val NV_blend_equation_advanced = list.contains("GL_NV_blend_equation_advanced")
        val NV_deep_texture3D = list.contains("GL_NV_deep_texture3D")
        val NV_shader_thread_group = list.contains("GL_NV_shader_thread_group")
        val NV_shader_thread_shuffle = list.contains("GL_NV_shader_thread_shuffle")
        val NV_shader_atomic_int64 = list.contains("GL_NV_shader_atomic_int64")
        val NV_bindless_multi_draw_indirect_count = list.contains("GL_NV_bindless_multi_draw_indirect_count")
        val NV_uniform_buffer_unified_memory = list.contains("GL_NV_uniform_buffer_unified_memory")

        // AMD
        val ATI_texture_compression_3dc = list.contains("GL_ATI_texture_compression_3dc")
        val AMD_depth_clamp_separate = list.contains("GL_AMD_depth_clamp_separate")
        val AMD_stencil_operation_extended = list.contains("GL_AMD_stencil_operation_extended")
        val AMD_vertex_shader_viewport_index = list.contains("GL_AMD_vertex_shader_viewport_index")
        val AMD_vertex_shader_layer = list.contains("GL_AMD_vertex_shader_layer")
        val AMD_shader_trinary_minmax = list.contains("GL_AMD_shader_trinary_minmax")
        val AMD_interleaved_elements = list.contains("GL_AMD_interleaved_elements")
        val AMD_shader_atomic_counter_ops = list.contains("GL_AMD_shader_atomic_counter_ops")
        val AMD_occlusion_query_event = list.contains("GL_AMD_occlusion_query_event")
        val AMD_shader_stencil_value_export = list.contains("GL_AMD_shader_stencil_value_export")
        val AMD_transform_feedback4 = list.contains("GL_AMD_transform_feedback4")
        val AMD_gpu_shader_int64 = list.contains("GL_AMD_gpu_shader_int64")
        val AMD_gcn_shader = list.contains("GL_AMD_gcn_shader")

        // Intel
        val INTEL_map_texture = list.contains("GL_INTEL_map_texture")
        val INTEL_fragment_shader_ordering = list.contains("GL_INTEL_fragment_shader_ordering")
        val INTEL_performance_query = list.contains("GL_INTEL_performance_query")
    }
